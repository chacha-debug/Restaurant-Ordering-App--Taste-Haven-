 ...
 * @author Admin
 */
public class KitchenMessagePanel extends JPanel{
    ...
    public KitchenMessagePanel() {
        setLayout(new BorderLayout(10, 10));
        setBorder(BorderFactory.createEmptyBorder(15, 15, 15, 15));
        setBackground(Color.WHITE);
        setPreferredSize(new Dimension(800, 800));

        JLabel titleLabel = new JLabel("Messages Between Waiter and Chef", SwingConstants.CENTER);
        ...
        sendMessageButton.addActionListener(e -> sendMessageToChef());
        ...
        JLabel inputLabel = new JLabel("Message to Chef:");
    ...
    private void sendMessageToChef() {
        ...
        String insertSql = "INSERT INTO chef_waiter_messages (sender_role, message_text, status) VALUES ('waiter', ?, 'new')";
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            JOptionPane.showMessageDialog(this, "Message sent to the chef.");
